...
/* harmony import */ var _components_utilities_Loading__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/components/utilities/Loading */ "./resources/js/components/utilities/Loading.vue");
/* harmony import */ var qrcode__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! qrcode */ "./node_modules/qrcode/lib/browser.js");
/* harmony import */ var _components_credit_AddCredit_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/components/credit/AddCredit.vue */ "./resources/js/components/credit/AddCredit.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    Alert: majra__WEBPACK_IMPORTED_MODULE_1__.Alert,
    Loading: _components_utilities_Loading__WEBPACK_IMPORTED_MODULE_4__["default"],
    AddCredit: _components_credit_AddCredit_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  ...
  methods: {
    getSafe: lodash__WEBPACK_IMPORTED_MODULE_2__.get,
    createQr: function createQr() {
      var _this = this;

      setTimeout(function () {
        var _iterator = _createForOfIteratorHelper(_this.toDayReserves),
            _step;
    ...
    persianDate: function persianDate(date) {
      return new Date(date).toLocaleDateString("fa-IR");
    },
    hasReserve: function hasReserve() {
      return this.selectedMeal.findIndex(function (meal) {
        return meal.is_reserved;
      }) > -1;
    },
    isMealPast: function isMealPast() {
      return this.selectedMeal.findIndex(function (meal) {
        return meal.is_past;
      }) > -1;
    },
    ...
    checkReserve: function checkReserve(_ref) {
      var meal = _ref.meal,
          day = _ref.day;
      var key = this.weekMap[day].standardDate;
      var selectedMeal = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.get)(this.meals, key + "." + meal, []);

      var _iterator2 = _createForOfIteratorHelper(selectedMeal),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var _meal = _step2.value;

          if (_meal.is_reserved) {
            return _meal.food.name;
          }
        }
      } catch (err) {
        _iterator2.e(err);
    ...
    chooseMeal: function chooseMeal(_ref2) {
      var meal = _ref2.meal,
          day = _ref2.day;
      var key = this.weekMap[day].standardDate;
      var selectedMeal = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.get)(this.meals, key + "." + meal);
    ...
    makePlan: function makePlan() {
      var i = 0;
      var startOfWeek = new Date(this.startOfWeek);
      ...
      for (var nameOfWeek in this.weekMap) {
        ...
        this.weekMap[nameOfWeek].standardDate = year + "-" + ((month > 9 ? "" : "0") + month) + "-" + ((day > 9 ? "" : "0") + day);
      }
    }
  }
});
    ...
    [
            ...
            [
              _c(
                ...
                [
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "v-btn",
                            {
                              staticClass: "primary py-1 px-2 ml-2",
                              attrs: { small: "", elevation: "0", dark: "" },
                              on: {
                                click: function ($event) {
                                  ;[(_vm.fishDialog = true), _vm.createQr()]
                                },
                              },
                            },
                            [
                              _c("v-icon", { attrs: { small: "" } }, [
                                _vm._v("mdi mdi-note-text"),
                              ]),
                              _vm._v(" "),
                              _c("span", [_vm._v("ژتون")]),
                            ],
                          ...
                          _vm._v(" "),
                          _c("AddCredit", { attrs: { "is-company": false } }),
                        ],
                        1
                      ),
                    ]
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("div", { staticClass: "d-flex" }, [
                          _c("span", [
                            _vm._v(_vm._s(_vm.persianDate(_vm.time))),
                          ]),
                          _vm._v(" "),
                          _vm.isToday
                  ...
                  _vm._v(" "),
                  _c("v-col", { key: _vm.day, attrs: { cols: "12 pa-0" } }, [
                    _c("table", { staticClass: "col-12 pa-0" }, [
                      _c("thead", [
                        _c("tr", [
                          _c("td", [_vm._v("روز")]),
                          _vm._v(" "),
                      ...
                      _c(
                        ...
                        _vm._l(_vm.company.business_days, function (day) {
                          return _c("tr", [
                            _c("td", [
                              _vm.persianDate(_vm.weekMap[day].date) ===
                              _vm.persianDate(new Date())
                                ? _c(
                                    "span",
                                    [
                                      _c("v-icon", [
                              ...
                              _vm._v(" "),
                              _c("span", [
                                _vm._v(_vm._s(_vm.weekMap[day].name)),
                              ]),
                              _vm._v(" "),
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _c("v-card-title", [
                        _c("span", [_vm._v("غذا ها")]),
                        _vm._v(" "),
                        _vm.isMealPast()
                          ? _c("span", { staticClass: "caption mx-2" }, [
                              _vm._v(
                                "(زمان رزرو غذا در این روز به پایان رسیده)"
                              ),
                            ])
                          : _vm._e(),
                      ]),
                      ...
                      _c("v-card-text", [
                        _c(
                          ...
                          _vm._l(_vm.selectedMeal, function (meal) {
                            return _c(
                              "div",
                              {
                                staticClass:
                                  "d-flex align-center justify-space-between my-2",
                              },
                              [
                                _c("span", [_vm._v(_vm._s(meal.food.name))]),
                                _vm._v(" "),
                                _c("span", [_vm._v(_vm._s(meal.price))]),
                                _vm._v(" "),
                                _c(
                                  "v-btn",
                                  {
                                    attrs: {
                                      disabled:
                                        meal.is_past ||
                                        !(
                                          meal.is_reserved || !_vm.hasReserve()
                                        ),
                                      icon: "",
                                      color: meal.is_reserved
                                        ? "error"
                                        : "green",
                                    },
                                    on: {
                                      click: function ($event) {
                                        return _vm.reserve(meal)
                                      },
                                    },
                                  },
                                  [
                                    !meal.is_reserved
                                      ? _c("v-icon", [_vm._v("mdi mdi-check")])
                                      : _c("v-icon", [_vm._v("mdi mdi-close")]),
                                  ],
                                  1
                                ),
      ...
      _c(
        "v-dialog",
        {
          attrs: { "max-width": "500px" },
          model: {
            value: _vm.fishDialog,
            callback: function ($$v) {
              _vm.fishDialog = $$v
            },
            expression: "fishDialog",
          },
        },
        [
          _c(
